...
// Mapper 066: GxROM (GNROM/MHROM)
// Used by: Super Mario Bros. + Duck Hunt, Gumshoe, Doraemon
// Features:
// - 32KB switchable PRG bank at $8000-$FFFF
// - 8KB switchable CHR bank at $0000-$1FFF
// - Fixed mirroring (set by cartridge hardware)
// - Similar to Color Dreams but different bit layout
class Mapper066 : public Mapper {
public:
    Mapper066(std::vector<uint8_t>& prg_rom,
